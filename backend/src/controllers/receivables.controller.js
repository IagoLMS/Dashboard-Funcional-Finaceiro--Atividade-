import { receivablesService as svc } from '../services/receivables.service.js';
...
export const receivablesController = {
  ...
  registerPayment: async (req, res, next) => { try { res.json(await svc.registerPayment(Number(req.params.id), req.body)); } catch(e) { next(e); } },
};
