...
import { CASH_FLOW_CATEGORIES } from '../utils/data';
...
export default function CashFlowPage() {
  const { data: entries, create, update: updateEntry, remove } = useCashFlow();
  ...
  const handleSave = async () => {
    ...
    else                   await updateEntry(activeEntry.id, payload);
