...
import {
  ...
  Clock, Download, Eye, FileText, Filter, MoreHorizontal, MoreVertical, Pencil, Plus,
                  ...
                  <tr key={r.id} className="hover:bg-primary/10 duration-300 cursor-pointer">
                    ...
                    <td className={`${tdClass} whitespace-nowrap`}>
                      <div className="flex justify-end items-center gap-1">
                        ...
                        <button
                          title="Ver detalhes"
                          onClick={() => { setActive(r); setModal('view'); }}
                        ...
                        {canEdit(r) && (
                          <button
                            title="Editar"
                            onClick={() => { setActive(r); setModal('edit'); }}
                            className="p-[8px] rounded-md bg-slate-50 border border-slate-200 text-gray-600 hover:bg-slate-200 cursor-pointer transition-colors"
                          >
                            <Pencil size={13} />
                          </button>
                        )}
                        ...
                        {canPay(r) && (
                          <button
                            ...
                            onClick={() => { setActive(r); setModal('pay'); }}
                            className="p-[8px] rounded-md bg-blue-50 border border-blue-200 text-blue-700 hover:bg-blue-100 cursor-pointer transition-colors"
                          >
                        ...
                        {canCancel(r) && (
                          <button
                            ...
                            onClick={() => { setActive(r); setModal('cancel'); }}
                            className="p-[8px] rounded-md bg-white border border-red-200 text-red-500 hover:bg-red-50 cursor-pointer transition-colors"
                          >
                            <Ban size={13} />
                          </button>
                        )}
